...
- name: Azure Recovery Service API Registered Identities Delete
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/entities/master/_listings/azure-recovery-services/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-recoveryservices-vaults-vaultname-registeredidentities-identityname-delete-postman.md
x-common:
